...
export const rooms: Room[] = [
  ...
  {
    id: "mv-101", number: "MV 101", seoName: "Skardu City View Budget Room 101", seoUrl: "skardu-city-view-budget-room-101",
    type: "Standard" as const, price: 4000, status: "Available" as const, floor: "1st Floor" as const,
    description: "Comfortable budget-friendly room perfect for families visiting Skardu city.",
    seoDescription: "Affordable family room in Skardu city center. Ideal for budget travelers, families, and groups visiting Skardu.",
    capacity: "2-3 Guests (Family Suitable)", amenities: ["Free Wi-Fi", "Hot Water", "Basic TV", "City View", "Free Parking"],
    image: "/gallery/room-mountain-view.jpeg", imageAlt: "budget family room 101 in Skardu city with mountain views",
  },
  {
    id: "mv-102", number: "MV 102", seoName: "Skardu City View Budget Room 102", seoUrl: "skardu-city-view-budget-room-102",
    type: "Standard" as const, price: 4000, status: "Available" as const, floor: "1st Floor" as const,
    description: "Comfortable budget-friendly room with scenic garden views.",
    seoDescription: "Affordable family room in Skardu city center with scenic views. Ideal for budget travelers visiting Skardu.",
    capacity: "2-3 Guests (Family Suitable)", amenities: ["Free Wi-Fi", "Hot Water", "Basic TV", "City View", "Free Parking"],
    image: "/gallery/room-scenic.jpeg", imageAlt: "budget family room 102 in Skardu with scenic views",
  },
  {
    id: "mv-103", number: "MV 103", seoName: "Skardu City View Budget Room 103", seoUrl: "skardu-city-view-budget-room-103",
    type: "Standard" as const, price: 4000, status: "Available" as const, floor: "1st Floor" as const,
